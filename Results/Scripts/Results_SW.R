...
# Last updated 05/30/2023 by Hana
...
# check to make sure it runs, delete later
...
median_cost <- quantile(cost, probs = c(0.5)) + 7222218.88 # sweep one-time cost based on wk 53 pop of 26,267.39
lower_new_cost <- quantile(cost, probs = c(0.025)) + 7222218.88 # sweep one-time cost based on wk 53 pop of 26,267.39
upper_new_cost <- quantile(cost, probs = c(0.975)) + 7222218.88 # sweep one-time cost based on wk 53 pop of 26,267.39
